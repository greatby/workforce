const WindsurfHeroBackground = () => (
  ...
  >
    ...
    >
      <g clip-path="url(#clip0_27413_564)">
        ...
        <path
          ...
          fill="url(#paint1_radial_27413_564)"
        ></path>
        <path
          ...
          fill="url(#paint2_radial_27413_564)"
        ></path>
        <path
          ...
          fill="url(#paint3_radial_27413_564)"
        ></path>
        <path
          ...
          fill="url(#paint4_radial_27413_564)"
        ></path>
        <path
          ...
          fill="url(#paint5_radial_27413_564)"
        ></path>
        <path
          ...
          fill="url(#paint6_radial_27413_564)"
        ></path>
        <path
          ...
          fill="url(#paint7_radial_27413_564)"
        ></path>
        <path
    ...
    <div
      className="pointer-events-none absolute z-[5] hidden overflow-hidden md:block md:left-[113rem] md:top-[88rem]"
      style={{
        width: "4500px",
        height: "2420px",
        boxShadow:
          "inset 200px 80px 50px -10px rgba(1,28,66,1), inset -150px -150px 50px -10px rgba(1,28,66,1)",
      }}
      aria-hidden="true"
    />
  </div>
